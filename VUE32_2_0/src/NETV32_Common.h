...
enum CANResourceId {
	    ...
	    E_ID_ODOMETER = 0x1d,
            ...
            E_ID_BMS_STATE_ERROR = 0x27,
            E_ID_BMS_STATE_BALANCING = 0x28,
            E_ID_AUDIOAMPLIFIER = 0x29,
            E_ID_SET_LIGTH_STATE = 0x2a,
            E_ID_SET_BRAKE_LIGTH_STATE = 0x2b,
            E_ID_TRUNK_SIGNAL = 0x2c,
            E_ID_BMS_TENSIONS = 0x2d,
            E_ID_BMS_TEMPERATURES = 0x2e,
            E_ID_SET_WIPER_STATE = 0x33,
            E_ID_SET_ROOF_LIGTH = 0x35,
            E_ID_SET_ROOF_LIGTH_FROM_RIGHT = 0x36,
            E_ID_SET_ROOF_LIGTH_FROM_LEFT = 0x37,
            E_ID_SET_ROOF_LIGTH_FROM_TRUNK = 0x38,
            E_ID_SET_REVERSE_LIGTH_STATE = 0x39
