...
#include "USB\usb.h"
//#include "NetV\NETV32_Common.h"
//#include "NetV\NETV32_Shared.h"
//#include "NETV32_SerialDriver.h"

//The USB software was provided by Microchip (USB Device - CDC - BasicDemo)
//It needs to be trimmed down (ex.: remove LEDs, remove boards, etc.)

//Note: select the peripherals you want to activate in def.h
...
unsigned int adc_buf[ADC_CHANNELS];
